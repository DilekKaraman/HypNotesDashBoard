...
#    Then user verifies Spanish language "https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/es.json"
    Given user verifies languages
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/es.json |
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/tr.json |
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/de.json |
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/fr.json |
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/ru.json |
      | https://test.hypnotes.net/_next/data/hlwOUMqUoGOBUVM5dkoJx/es.json |
